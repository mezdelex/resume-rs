...
pub static PROJECTS: Lazy<Vec<Project>> = Lazy::new(|| {
    vec![
        Project {
            ...
            app: String::from("https://github.com/leptos-rs/leptos"),
            description: String::from("A work in progress replica of the Vue 3 resume, developed using Rust (btw), and the Leptos WASM framework in CSR trunk mode, Thaw UI library, Serde, Tokio, Reqwest, Chrono, etc. Coded with Neovim (btw)."),
        },
        Project {
        ...
        Project{
            ...
            description: String::from("Algorithmic problem solving to achieve further Rust language proficiency with data structures, mutability and other language specific stuff. Also added CI pipeline via GitHub Actions to run testing jobs server side. Coded with Neovim."),
        },
        Project{
            ...
            description: String::from("Rust repository containing examples on various topics related to the language, such as concurrency, mutability, borrowing, lifetimes, data structures, etc. Work in progress. Coded with Neovim."),
        },
        Project{
        ...
        Project{
            ...
            description: String::from("A Discord bot written in Python to facilitate the sharing of information between guild members of the mobile game Mobile Legends: Adventure. The bot needs to be run either locally or hosted in a dedicated server so the commands can be recognized by Discord."),
        },
        Project{
        ...
        Project{
            ...
            description: String::from("Algorithmic problem solving to achieve further C# 11 language proficiency in declarative paradigm using LINQ, Lambdas and Expression-Bodied members. Also added CI pipeline via GitHub Actions to run testing jobs server side. Coded with VSCode."),
        },
        Project{
            id: String::from(""),
            ...
            description: String::from("A journey started in May 2022 to improve my touch typing skills and eventually increase my productivity. My current best mark is at 125 WPM with 100% accuracy & 90% consistency @ monkeytype 15s typing test."),
        },
        Project{
            ...
            description: String::from("A small project done with React 18 using hooks, functional components, context, context provider, props destructuring, children reserved word and kind of higher order component-ish approach to be able to reuse hook logic. The deployment has been done using GitHub's CD pipeline against Netlify. Coded with VSCode."),
        },
        Project{
        ...
        Project{
            ...
            description: String::from("Technical test using Spring Boot 2.4.5, Vue 3 Composition API with PrimeVUE as UI library and IBM's FileNet service as automated document manager. Coded with VSCode. The project was not deployed anywhere so the link it's a YouTube demo."),
        },
        Project{
        ...
        Project{
            ...
            description: String::from("RESTful API done with Spring Boot 2.4.5, Gradle 6.8.2 and Java JDK 11+. Used MVC, Hibernate/JPA, QueryDSL, HATEOAS, JUnit, Mockito, custom mapper, common interfaces, dockerfile, docker-compose, YAML formatting, etc. MySQL DB is hosted by Heroku's JawsDB service. Coded with VSCode. JawsDB service shutsdown the DB after 30 min of inactivity, so if you don't see any content let it boot."),
        },
        Project{
            ...
            description: String::from("Algorithmic problem solving to achieve further Java's JDK 11+ language proficiency in declarative paradigm using streams, lambdas and functional interfaces. Coded with VSCode."),
        },
        Project{
            ...
            description: String::from("HackerRank exercises to keep algorithmic problem solving fresh and improve my expertise with Java's JDK 11+ declarative and imperative syntax and to learn functional programming paradigm using Haskell. Coded with VSCode."),
        },
        Project{
            ...
            description: String::from("My first Web App back in 2020 done with Javascript, HTML, CSS and Bootstrap consuming an external Trivia API that required token authorization to be accessed. Coded with VSCode."),
        }
    ]
});
